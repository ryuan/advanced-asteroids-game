...
public class Menu {
    ...
    public void run() {
        ...
        while (true) {
            ...
            if (selection == 999) {
            ...
            else if(selection > catalog.size() || selection < 0) {
                ...
                while (true) {
                    ...
                    output.println("Do you want to insert more coins? Press Y or N.");
                    char chRepeat = input.nextLine().charAt(0);
                    if (chRepeat == 'N' || chRepeat == 'n') {
                        break;
                    }
                }
